...
<html lang="en">
    <head>
        ...
        <link href="${ctx}/statics/css/icons.css" rel="stylesheet" />
        <link href="${ctx}/statics/css/bootstrap.css" rel="stylesheet" />
        <link href="${ctx}/statics/css/main.css" rel="stylesheet" />
    </head>
    ...
    <script src="${ctx}/statics/js/jquery-1.10.2.min.js" ></script>
    		...
    		$("#loginBtn").click(function() {
    			...
    			$.post("${ctx}/user/login", {userName:userName, password:password}, function(resp) {
    				if (resp.status == 0) {
    					...
    					alert(resp.msg);
    					console.log(resp);
//    					$.cookie("userId", resp.data.id);
//    					$.cookie("userName", resp.data.userName);
//    					$.cookie("realName", resp.data.trueName);
