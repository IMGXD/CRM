        ...
        <table cellspacing="8px">
            ...
            <tr>
                ...
                <td colspan="4">
                    <textarea rows="5" cols="50" id="description" name="description"
                              style="margin: 0px;width: 421px;height: 75px;resize: none;"></textarea>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td><input class="easyui-combobox" id="assignMan" name="assignMan"
                           data-options="panelHeight:'auto',editable:false,valueField:'trueName',textField:'trueName',url:'${ctx}/user/find_customer_manager'"/>
                </td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
            </tr>
        </table>
...
<script src="/statics/js/sale.chance.js"></script>
</html>